...
var showAlert = function showAlert(alertType, alertMsg) {
  var warningMarkup = "<div class=\"alert__box alert__warning\"><svg><use xlink:href=\"src/img/icon-pack-2.svg#danger\"></use></svg><p class=\"alert__text\">MESSAGE</p></div>";
  var successMarkup = "<div class=\"alert__box alert__success\"><svg><use xlink:href=\"src/img/icon-pack-2.svg#happy\"></use></svg><p class=\"alert__text\">MESSAGE</p></div>";
  var errorMarkup = "<div class=\"alert__box alert__error\"><svg><use xlink:href=\"src/img/icon-pack-2.svg#sad\"></use></svg><p class=\"alert__text\">MESSAGE</p></div>";
...
},{"./alert":"alert.js","./navbarToggler":"navbarToggler.js","./landing_slider.js":"landing_slider.js","./reviewSlider":"reviewSlider.js","./getLocation":"getLocation.js","./swiper":"swiper.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
